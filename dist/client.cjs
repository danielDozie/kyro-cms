'use strict';var html=require('@tiptap/html'),y=require('@tiptap/starter-kit'),b=require('@tiptap/extension-link'),F=require('@tiptap/extension-image'),h=require('@tiptap/extension-text-align'),k=require('@tiptap/extension-underline'),T=require('@tiptap/extension-highlight'),w=require('@tiptap/extension-task-list'),R=require('@tiptap/extension-task-item'),extensionTextStyle=require('@tiptap/extension-text-style'),C=require('@tiptap/extension-color');function _interopDefault(e){return e&&e.__esModule?e:{default:e}}var y__default=/*#__PURE__*/_interopDefault(y);var b__default=/*#__PURE__*/_interopDefault(b);var F__default=/*#__PURE__*/_interopDefault(F);var h__default=/*#__PURE__*/_interopDefault(h);var k__default=/*#__PURE__*/_interopDefault(k);var T__default=/*#__PURE__*/_interopDefault(T);var w__default=/*#__PURE__*/_interopDefault(w);var R__default=/*#__PURE__*/_interopDefault(R);var C__default=/*#__PURE__*/_interopDefault(C);var p=["text","number","checkbox","date","email","password","textarea","select","radio","color","icon"],g=["richtext","json","code","upload","image","markdown"],m=["relationship","array","group","blocks"],x=["row","collapsible","tabs"],u=[...p,...g,...m,...x];var B=`
.kyro-richtext {
  color: inherit;
  line-height: 1.7;
}
...
`.trim(),A=[y__default.default,b__default.default.configure({openOnClick:false}),F__default.default,h__default.default.configure({types:["heading","paragraph"]}),k__default.default,T__default.default.configure({multicolor:true}),w__default.default,R__default.default.configure({nested:true}),extensionTextStyle.TextStyle,C__default.default];function v(e){if(typeof e!="object"||e===null)return "";try{return `<div class="kyro-richtext">${html.generateHTML(e,A)}</div>`}catch(t){return console.error("Failed to render rich text:",t),""}}var s=class{constructor(t){this.config=t;}config;css=[];addRule(t,r){let i=Object.entries(r).map(([o,a])=>`  ${o}: ${a};`).join(`
